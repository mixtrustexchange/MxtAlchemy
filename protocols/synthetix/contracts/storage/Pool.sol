...
import "@alchemyio/core-contracts/contracts/errors/AccessError.sol";
...
library Pool {
    ...
    struct Data {
         ...
         *
         * Each collateral type will have its own vault, specific to this pool. I.e. if two pools both use MXT collateral, each will have its own MXT vault.
         *
