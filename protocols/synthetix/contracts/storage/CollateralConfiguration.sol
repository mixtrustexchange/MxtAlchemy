...
import "@alchemyio/oracle-manager/contracts/storage/NodeOutput.sol";
...
library CollateralConfiguration {
    bytes32 private constant _SLOT_AVAILABLE_COLLATERALS =
        keccak256(
            abi.encode("io.alchemy.alchemy.CollateralConfiguration_availableCollaterals")
        );
    ...
    struct Data {
        ...
        /**
         * @dev System-wide collateralization ratio for issuance of alchemyUSD.
         * Accounts will not be able to mint alchemyUSD if they are below this issuance c-ratio.
         */
    ...
    /**
     * @dev Reverts if the specified collateral and debt values produce a collateralization ratio which is below the amount required for new issuance of alchemyUSD.
