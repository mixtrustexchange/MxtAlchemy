...
interface ICollateralModule {
     ...
     * @dev Collateral locks are initially intended for the Alchemy v2 to v3 migration, but may be used in the future by the Spartan Council, for example, to create and hand off accounts whose withdrawals from the system are locked for a given amount of time.
