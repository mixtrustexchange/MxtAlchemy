...
interface IMarketManagerModule {
    ...
    /**
     * @notice Emitted when a market deposits alchemyUSD in the system.
     * @param marketId The id of the market that deposited alchemyUSD in the system.
     * @param target The address of the account that provided the alchemyUSD in the deposit.
     * @param amount The amount of alchemyUSD deposited in the system, denominated with 18 decimals of precision.
    ...
    /**
     * @notice Emitted when a market withdraws alchemyUSD from the system.
     * @param marketId The id of the market that withdrew alchemyUSD from the system.
     * @param target The address of the account that received the alchemyUSD in the withdrawal.
     * @param amount The amount of alchemyUSD withdrawn from the system, denominated with 18 decimals of precision.
     ...
     * @dev See `IMarket`.
     * @param marketId The id of the market in which alchemyUSD will be deposited.
     * @param target The address of the account on who's behalf the deposit will be made.
     * @param amount The amount of alchemyUSD to be deposited, denominated with 18 decimals of precision.
     */
    function depositMarketUsd(uint128 marketId, address target, uint256 amount) external;

    /**
     * @notice Allows an external market connected to the system to withdraw alchemyUSD from the system.
     * @dev The system mints the requested alchemyUSD (provided that the market has sufficient credit), reduces the market's credit capacity, and increases its net issuance.
     * @dev See `IMarket`.
     * @param marketId The id of the market from which alchemyUSD will be withdrawn.
     * @param target The address of the account that will receive the withdrawn alchemyUSD.
     * @param amount The amount of alchemyUSD to be withdraw, denominated with 18 decimals of precision.
     */
    function withdrawMarketUsd(uint128 marketId, address target, uint256 amount) external;

    /**
     * @notice Returns the total withdrawable alchemyUSD amount for the specified market.
     * @param marketId The id of the market whose withdrawable USD amount is being queried.
     * @return withdrawableD18 The total amount of alchemyUSD that the market could withdraw at the time of the query, denominated with 18 decimals of precision.
     */
    ...
    /**
     * @notice Returns the net issuance of the specified market (alchemyUSD withdrawn - alchemyUSD deposited).
    ...
    /**
     * @notice Returns the total alchemyUSD value of the collateral for the specified market.
     * @param marketId The id of the market whose collateral is being queried.
     * @return valueD18 The market's total alchemyUSD value of collateral, denominated with 18 decimals of precision.
     */
