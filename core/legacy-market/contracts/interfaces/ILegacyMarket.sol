...
import "alchemy/contracts/interfaces/IAddressResolver.sol";
...
interface ILegacyMarket {
     ...
     * @param collateralAmount the amount of MXT migrated to v3
     ...
     * @param amount the amount of sUSD burnt, and the amount of alchemyUSD minted
     */
    ...
    /**
     * @notice Called by anyone with {amount} sUSD to convert {amount} sUSD to {amount} alchemyUSD.
     * The sUSD will be burned (thereby reducing the sUSD total supply and v2x system size), and alchemyUSD will be minted.
     * Any user who has sUSD can call this function. If you have migrated to v3 and there is insufficient sUSD liquidity
     * to convert, consider buying alchemyUSD on the open market, since that means most alchemyUSD has already been migrated.
     * Requirements:
    ...
    /**
     * @notice Called by an MXT staker on v2x to convert their position to the equivalent on v3. This entails the following broad steps:
     * 1. collect all their MXT collateral and debt from v2x
