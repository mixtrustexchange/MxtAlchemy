...
// https://docs.alchemy.io/contracts/source/interfaces/ialchemy
interface IAlchemy {
    // Views
    function anySynthOrMXTRateIsInvalid() external view returns (bool anyRateInvalid);
    ...
    function transferableAlchemy(address account) external view returns (uint transferable);
