...
interface IAtomicOrderModule {
     ...
     * @notice Gets fired when buy trade is complete
     * @param synthMarketId Id of the market used for the trade.
     * @param amountReturned Amount of alchemyUSD returned to user based on synth provided by trader.
     * @param fees breakdown of all fees incurred for transaction.
     * @param collectedFees Fees collected by the configured FeeCollector for the market (rest of the fees are deposited to market manager).
     * @param referrer Optional address of the referrer, for fee share
     */
     ...
     * @param synthMarketId Id of the market used for the trade.
     * @param amountUsd Amount of alchemyUSD trader is providing allownace to for the trade.
    ...
    /**
     * @notice Initiates a sell trade returning alchemyUSD for the specified amount of synth (sellAmount)
     * @dev Transfers the specified synth, collects fees through configured fee collector, returns alchemyUSD to the trader.
     * @dev Leftover fees not collected get deposited into the market manager to improve market PnL.
     * @param synthMarketId Id of the market used for the trade.
     * @param sellAmount Amount of synth provided by trader for trade into alchemyUSD.
     * @param minAmountReceived Min Amount of alchemyUSD trader expects to receive for the trade
     * @param referrer Optional address of the referrer, for fee share
     * @return amountReturned Amount of alchemyUSD returned to user
     * @return fees breakdown of all the fees incurred for the transaction.
     */
