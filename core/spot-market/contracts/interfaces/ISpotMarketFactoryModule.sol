...
interface ISpotMarketFactoryModule is IMarket {
     ...
     * @param alchemyAddress configured alchemy v3 core system
     * @param usdTokenAddress configured alchemyUSD token address
    ...
    /**
     * @notice Creates a new synth market with alchemy v3 core system via market manager
     ...
     * @param tokenName name of synth (i.e Alchemy ETH)
     * @param tokenSymbol symbol of synth (i.e alchemyETH)
