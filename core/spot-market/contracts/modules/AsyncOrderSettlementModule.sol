...
contract AsyncOrderSettlementModule is IAsyncOrderSettlementModule {
    ...
    */
    ...
    function _settleSellOrder(
        ...
        spotMarketFactory.alchemy.withdrawMarketUsd(marketId, msg.sender, settlementReward);
        spotMarketFactory.alchemy.withdrawMarketUsd(marketId, trader, finalOrderAmount);
    }
