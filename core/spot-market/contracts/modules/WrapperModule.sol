...
contract WrapperModule is IWrapperModule {
    ...
    function wrap(
        ...
        wrapperStore.checkMaxWrappableAmount(marketId, wrapAmountD18, spotMarketFactory.alchemy);

        wrappingCollateral.transferFrom(msg.sender, address(this), wrapAmount);
        wrappingCollateral.approve(address(spotMarketFactory.alchemy), wrapAmount);
        spotMarketFactory.alchemy.depositMarketCollateral(
            marketId,
    ...
    function unwrap(
        ...
        spotMarketFactory.alchemy.withdrawMarketCollateral(
            marketId,
            wrapperStore.wrapCollateralType,
