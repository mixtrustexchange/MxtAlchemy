    ...
    InitializableMixin
{
    ...
    function _isInitialized() internal view override returns (bool) {
        ...
        return
            address(spotMarketFactory.alchemy) != address(0) &&
    ...
    function initialize(
        ...
        spotMarketFactory.alchemy = alchemyAddress;
    ...
    function createSynth(
        ...
        SpotMarketFactory.Data storage spotMarketFactory = SpotMarketFactory.load();
        uint128 synthMarketId = spotMarketFactory.alchemy.registerMarket(address(this));
