...
import assertBn from '@alchemyio/core-utils/src/utils/assertions/assert-bignumber';
...
describe('SpotMarketFactory', () => {
  ...
  describe('locked', () => {
    ...
    before('user1 buys 10 alchemyEth', async () => {
