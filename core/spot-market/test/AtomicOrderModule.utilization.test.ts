...
describe('Atomic Orders Utilization Rate tests', () => {
  ...
  describe('with 1x leverage', () => {
    ...
    it('sent 90 alchemyETH to trader', async () => {
    ...
    describe('trader2 buys 20 eth', () => {
      ...
      it('sent less than 19.9 alchemy ETH to trader', async () => {
        // 20 * 0.5% =
  ...
  describe('with 2x leverage', () => {
    ...
    it('sent 150 alchemyETH to trader', async () => {
    ...
    describe('trader2 buys 60 eth', () => {
      ...
      it('sent less than 60 alchemyETH to trader', async () => {
        //
