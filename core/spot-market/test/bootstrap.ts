import { snapshotCheckpoint } from '@alchemyio/core-utils/utils/mocha/snapshot';
import NodeTypes from '@alchemyio/oracle-manager/test/integration/mixins/Node.types';
import { coreBootstrap } from '@alchemyio/router/utils/tests';
import { wei } from '@alchemyio/wei';
...
import {
  ...
  OracleVerifierMock,
  SpotMarketProxy,
  AlchemyCollateralMock,
  AlchemyCoreProxy,
  AlchemyOracle_managerProxy,
  AlchemyUSDProxy,
  SynthRouter,
...
type Proxies = {
  ['alchemy.CoreProxy']: AlchemyCoreProxy;
  ['alchemy.USDProxy']: AlchemyUSDProxy;
  ['alchemy.CollateralMock']: AlchemyCollateralMock;
  ['alchemy.oracle_manager.Proxy']: AlchemyOracle_managerProxy;
...
export type Systems = {
  ...
  Core: AlchemyCoreProxy;
  USD: AlchemyUSDProxy;
  CollateralMock: AlchemyCollateralMock;
  OracleManager: AlchemyOracle_managerProxy;
  OracleVerifierMock: OracleVerifierMock;
  FeeCollectorMock: FeeCollectorMock;
...
before('load contracts', () => {
  contracts = {
    Core: getContract('alchemy.CoreProxy'),
    USD: getContract('alchemy.USDProxy'),
    SpotMarket: getContract('SpotMarketProxy'),
    OracleManager: getContract('alchemy.oracle_manager.Proxy'),
    CollateralMock: getContract('alchemy.CollateralMock'),
...
/*
  same as protocol/alchemy/test/integration/bootstrap.ts#L70
