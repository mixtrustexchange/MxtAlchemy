...
describe('Atomic Order Module buy()', () => {
  const { systems, signers, marketId, restore } = bootstrapTraders(
    bootstrapWithSynth('Synthetic Ether', 'alchemyETH')
  ...
  describe('slippage', () => {
    ...
    it('trader1 has 0 alchemyETH', async () => {
  ...
  describe('no fees', () => {
    ...
    it('trader1 has 1 alchemyETH', async () => {
  ...
  describe('fixed fee', () => {
    ...
    it('trader1 has 0.99 alchemyETH after fees', async () => {
  ...
  describe('utilization rate fees', async () => {
    ...
    // market provided collateral = $100,000 alchemyUSD
    ...
    before('buy 50 alchemyETH', async () => {
    ...
    describe('when utilization is over 100%', () => {
      before('buy 100 alchemyETH', async () => {
  ...
  describe('skew fees', () => {
    ...
    describe('next trader buy', () => {
      ...
      it('trader2 gets 8.55 alchemyETH', async () => {
  ...
  describe('custom fee collector', () => {
    ...
    before('trader buys alchemyETH', async () => {
