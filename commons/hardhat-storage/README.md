...
Hardhat Plugin to validate storage usage on a set of solidity contracts. The intention of this library is to avoid any unintended storage side effects when using Proxy architectures. E.g. when using [`@alchemyio/router`](https://github.com/Alchemyio/alchemy-v3/tree/main/utils/router).
...
```
import '@alchemyio/hardhat-storage';
