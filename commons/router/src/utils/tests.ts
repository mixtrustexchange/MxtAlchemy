...
function _getContractFromOutputs(
  ...
  if (contractName.includes('.')) {
    ...
    // this logic handles deeply nested imports such as alchemy.oracle_manager.Proxy
    // which is really outputs.imports.alchemy.imports.oracle_manager.contracts.Proxy
